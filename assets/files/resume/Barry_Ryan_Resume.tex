...
\experience
    ...
    {March 2025 – Present}
    {
        \item Supporting hardware and software R\&D for robotic manipulators for use in space applications.
        \item Contributing to PCB design, software and firmware development, and data collection and analysis for robotic systems engineered for robustness in extreme space environments.
    }
