...
\experience
    ...
    {March 2025 – Present}
    {
        \item Designed electronics and software for fault-tolerant robotic manipulators for microgravity environments, emphasizing modularity and resilience to extreme temperature shifts and radiation.
        \item Designed custom PCBs in Altium for testing, actuator bringup, and spaceflight applications.
        \item Designed and implemented a custom Python SDK atop a ROS2 + EtherCAT stack, providing a joint-indexed interface for actuator telemetry, motion control, and peripheral management (brakes, heaters). Parses ROS2 joint state streams and exposes data as easily queryable Python dictionaries, while wrapping control services into intuitive function calls. Fully decouples application logic from ROS2 internals; now adopted by other teams in the lab, cutting integration and debug time by hours per actuator.
...
\begin{itemize}
    ...
    \item \href{https://ryanbarry.me/tools/data-visualizer/}{\textbf{CSV Visualizer Web App \textit{(Summer 2025)}}: Developed a browser-based CSV plotting tool with dynamic filtering, multi-series support, and health/error visualization.}
    
    \item \href{https://ryanbarry.me/tools/speed-reader/}{\textbf{Speed Reader Web App \textit{(Summer 2024)}}: Built a fully functional, state-driven single-page reading tool in vanilla JS/HTML/CSS; implemented real-time control logic (WPM, font, UI flow) without front-end libraries.}
