...
\experience
    ...
    {Rochester, NY}
    {August 2023 – May 2024 (planned to resume)}
    {
        \item  Conducting research on applying Proximal Policy Optimization to quadrupedal robot navigation using 2D/3D camera data and 360° LIDAR. 
        \item Integrated the PPO algorithm for real-time control, ongoing plans to refine the policy’s convergence and performance.
    }
...
\experience
    ...
    {
        \item \href{https://ryanbarry.me/projects/robotics/air-hockey-robot/}{Designed 3 DOF robot to play air hockey via YOLOv8 object detection and LSTM trajectory prediction.}
    }
...
\experience
    ...
    {February 2023 – April 2023}
    {
        ...
        \item \href{https://github.com/ryan-barry-99/Trajectory-Matching-Omnidirectional-Robot/tree/main/}{Explored detection and tracking in mobile robotics, utilizing YOLOv8 to follow a free-floating balloon.}
    }
    
\experience
    {\href{https://ryanbarry.me/projects/electrical-engineering/underwater-robot/}{Underwater Robot Control System}}
    {}
    {}
...
\experience
    {Collaborative Robot Interactive Game}
    {}
    {}
    {February 2023 – April 2023}
    {
        \item \href{https://github.com/ryan-barry-99/DeepSORT-with-OAK-D-for-Collaborative-Robots/tree/main}{Developed a ROS based interactive ball and cup game for Baxter robot with DeepSORT and YOLOv6.}
    }
...
\experience
    ...
    {
        \item Designed an autonomous mobile robot with a modified Nerf blaster to track and shoot at a moving shield.
    }
